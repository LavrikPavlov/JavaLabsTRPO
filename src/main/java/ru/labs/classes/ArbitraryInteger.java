...
public class ArbitraryInteger implements CustomArbitraryInteger {
    ...
    public ArbitraryInteger(ArbitraryInteger arbitraryInteger){
    ...
    public boolean equals(Object o) {
        ...
        return isNegative == that.isNegative && Objects.equals(bytes, that.bytes);
    }

    @Override
    public int hashCode() {
        return Objects.hash(bytes, isNegative);
    }
}